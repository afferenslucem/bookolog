  ...
  <div class="menu">
    ...
    <ul class="nav flex-column">
      ...
      <li class="nav-item to-read">
        <a class="nav-link" href="#" id="toReadListButton" @click="goToToRead()">Буду читать</a>
        <a class="icon nav-link" href="#" @click="goToAddToRead()">
          <i class="fa fa-lg fa-plus-square-o" aria-hidden="true"></i>
        </a>
      </li>
      <li class="nav-item done">
        <a class="nav-link" href="#" id="toDoneListButton" @click="goToDone()">Прочитал</a>
