...
export default {
  ...
  methods: {
    ...
    async goToAddInProgress() {
      this.$router.push({ name: 'CreateBook', params: { status: IN_PROGRESS_STATUS }});
      this.emitClick();
    },
    async goToToRead() {
    ...
    async goToAddToRead() {
      this.$router.push({ name: 'CreateBook', params: { status: TO_READ_STATUS }});
      this.emitClick();
    },
    async goToDone() {
    ...
    async goToAddDone() {
      this.$router.push({ name: 'CreateBook', params: { status: DONE_STATUS }});
      this.emitClick();
    },
  }
}
